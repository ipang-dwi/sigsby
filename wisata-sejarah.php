...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Wisata Sejarah - Sistem Informasi Geografis - Wisata Kota Surabaya</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
		  <ul class="nav navbar-nav">
			...
			<li class="active"><a href="#">Wisata Sejarah</a></li>
        ...
        $(function() {
					$('#map-container').storeLocator({
						'lengthUnit' : 'km',
 						'storeLimit' : -1,
						'dataType': 'json',
						'dataLocation': 'data/data-wisata-sejarah.json',
