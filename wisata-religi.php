...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Wisata Religi - Sistem Informasi Geografis - Wisata Kota Surabaya</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
		  <ul class="nav navbar-nav">
			...
			<li class="active"><a href="#">Wisata Religi</a></li>
        ...
        $(function() {
					$('#map-container').storeLocator({
						'lengthUnit' : 'km',
 						'storeLimit' : -1,
						'dataType': 'json',
						'dataLocation': 'data/data-wisata-religi.json',
