...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Peta - Sistem Informasi Geografis - Wisata Kota Surabaya</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
		  <ul class="nav navbar-nav">
			<li class="active"><a href="#">Peta Wisata</a></li>
        ...
        $(function() {
					$('#map-container').storeLocator({
						'lengthUnit' : 'km',
 						'storeLimit' : -1,
						//'dataType': 'json',
						//'dataLocation': 'data/data-semua.json',
						'dataLocation': 'data/wisata.xml',
						'inlineDirections' : true,
						autoGeocode: true,
						catMarkers : {
							'Event' : ['img/red-marker.png', 32, 32],
							'Wisata Kuliner' : ['img/blue-marker.png', 32, 32],
							'Wisata Religi' : ['img/cyan-marker.png', 32, 32],
							'Wisata Buatan' : ['img/green-marker.png', 32, 32],
							'Wisata Sejarah' : ['img/purple-marker.png', 32, 32],
							'Wisata Alam' : ['img/yellow-marker.png', 32, 32]
						}
					});
        });
      </script>
